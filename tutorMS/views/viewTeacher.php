...
$teacher=getTeacherFullInfo($_GET['id']);
$mediums = explode(",", $teacher['medium']);
...
<head>
	...
	<title>Tutor Management System | Teacher Details</title>
	<!-- Bootstrap core CSS -->
				...
				if($userInfo['approval_status']==0):?>
					...
					<?php else: ?>
						...
						<dl class="row">
							...
							<dd class="col-sm-9"> <?php echo $teacher["name"];?> </dd>

							<dt class="col-sm-3">Education</dt>
							<dd class="col-sm-9">
								<?php echo getEducation($teacher["education"]);?>
							</dd>

							<dt class="col-sm-3">Prefered Group</dt>
							<dd class="col-sm-9">
								<?php echo getGroup($teacher["group"]);?>
							</dd>

							<dt class="col-sm-3 text-truncate">Prefered Class</dt>
							<dd class="col-sm-9">
								<?php echo $teacher["class"];?>
							</dd>

							<dt class="col-sm-3">Teaching Medium</dt>
							<dd class="col-sm-9">
								<?php
								foreach($mediums as $medium)
								{
									echo getMedium($medium).",";
								}
								?>
							</dd>
							<dt class="col-sm-3 text-truncate">Status</dt>
							<dd class="col-sm-9">
								<?php echo getStatus($teacher["status"]);?>
							</dd>

							<dt class="col-sm-3">Gender</dt>
							<dd class="col-sm-9">
								<?php echo getGender($teacher["gender"]);?>
							</dd>
